...
class DevHub_Registrations {
	...
	public static function register_post_types() {
		...
		// Methods
		add_rewrite_rule( 'docs/reference/classes/page/([0-9]{1,})/?$', 'index.php?post_type=wp-parser-class&paged=$matches[1]', 'top' );
		add_rewrite_rule( 'docs/reference/classes/([^/]+)/([^/]+)/?$', 'index.php?post_type=wp-parser-method&name=$matches[1]-$matches[2]', 'top' );
	...
	public static function register_taxonomies() {
		...
		register_taxonomy( 'wp-parser-source-file', \DevHub\get_parsed_post_types(), array(
			...
			'hierarchical'          => true,
			'rewrite'               => array( 'with_front' => false, 'slug' => 'docs/reference/files', 'hierarchical' => true ),
			'sort'                  => false,
		...
		register_taxonomy( 'wp-parser-package', \DevHub\get_parsed_post_types(), array(
			...
			'label'                 => '@package',
			'public'                => true,
			'rewrite'               => array( 'with_front' => false, 'slug' => 'docs/reference/package' ),
			'sort'                  => false,
			'update_count_callback' => '_update_post_term_count',
			'show_in_rest'          => true,
		) );
		...
		register_taxonomy( 'wp-parser-since', \DevHub\get_parsed_post_types(), array(
			...
			'public'                => true,
			'rewrite'               => array( 'with_front' => false, 'slug' => 'docs/reference/since' ),
			'sort'                  => false,
			'update_count_callback' => '_update_post_term_count',
			'show_in_rest'          => true,
		) );
