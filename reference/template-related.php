		...
		<?php if ( $has_uses ) : ?>
			<article class="uses">
						...
						<tr>
							<td>
								...
								<a href="<?php the_permalink(); ?>"><?php the_title(); ?>
																<?php
																if ( ! in_array( get_post_type(), array( 'wp-parser-class', 'wp-parser-hook' ), true ) ) :
																	?>
									()<?php endif; ?></a>
							</td>
				...
				<a href="#" class="show-more">
					...
					printf(
						_n( 'Show %d more use', 'Show %d more uses', $uses->post_count - $uses_to_show, 'wporg' ),
		...
		<?php if ( $has_used_by ) : ?>
			...
			<article class="used-by">
				...
				<a href="#" class="show-more">
					...
					printf(
						_n( 'Show %d more used by', 'Show %d more used by', $used_by->post_count - $used_by_to_show, 'wporg' ),
